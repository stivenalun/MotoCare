...
#Preview {
    ModalSparepartView(data: .init(value: 75.0, minimum: 0.0, maximum: 100.0, iconSparePart: "engine-oil", labelText: "Oli Mesin", imageSparePart: "EngineOilImage", color: .red))
}
